...
<div itemscope itemtype="https://schema.org/Product">
	...
	<div class="primary_block">
				...
				{if $have_image}
					<span id="view_full_size">
						...
						{else}
							...
							{if !$content_only}
								<span class="span_link no-print" title="{l s='View larger'}" data-toggle="tooltip" data-placement="top">{l s='View larger'}</span>
							{/if}
						{/if}
					</span>
				{else}
		...
		<div class="pb-center-column col-xs-12 col-sm-7">
			<h1 class="product-name" itemprop="name">{$product->name|escape:'html':'UTF-8'}</h1>
						...
						<div{if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || (isset($restricted_country_mode) && $restricted_country_mode) || $PS_CATALOG_MODE} class="unvisible"{/if}>
							<p id="add_to_cart" class="buttons_bottom_block no-print">
								<button type="submit" name="Submit" class="btn exclusive">
									<span><i class="icon icon-plus"></i> {if $content_only && (isset($product->customization_required) && $product->customization_required)}{l s='Customize'}{else}{l s='Add to cart'}{/if}</span>
								</button>
							</p>
						</div>
...
{if !$content_only}
	...
	{assign var='hookProductSidebar' value={hook h='displayProductSidebar'}}
	
	<div class="col-xs-12 {if (isset($accessories) && $accessories) || $hookProductSidebar}col-sm-p80{else}col-sm-12{/if}">
	...
	{if (isset($accessories) && $accessories) || $hookProductSidebar }
...
<div class="product-container clearfix">
	<div class="left-block">
		<div class="product-image-container">
			<a class="product_img_link" href="{$accessory.link|escape:'html':'UTF-8'}">
				<img class="replace-2x img-responsive" src="{$link->getImageLink($accessory.link_rewrite, $accessory.id_image, 'medium_default')|escape:'html':'UTF-8'}" alt="{if !empty($accessory.legend)}{$accessory.legend|escape:'html':'UTF-8'}{else}{$accessory.name|escape:'html':'UTF-8'}{/if}" {if isset($mediumSize)} width="{$mediumSize.width}" height="{$mediumSize.height}"{/if} />
			</a>
		</div>
	</div>
	<div class="right-block">
		<h5>
			...
			<a class="product-name" href="{$accessory.link|escape:'html':'UTF-8'}" title="{$accessory.name|escape:'html':'UTF-8'}">
				{$accessory.name|truncate:45:'...'|escape:'html':'UTF-8'}
			</a>
		</h5>
		{if (!$PS_CATALOG_MODE && ((isset($accessory.show_price) && $accessory.show_price) || (isset($accessory.available_for_order) && $accessory.available_for_order)))}
