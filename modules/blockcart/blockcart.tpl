...
<div class="header-element header-element-right shopping_cart_wrapper clearfix{if $PS_CATALOG_MODE} header_user_catalog{/if}">
{/if}
	<div class="shopping_cart">
		<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
			...
			<span class="ajax_cart_no_product{if $cart_qties > 0} unvisible{/if}">{convertPrice price=0}</span>
		...
		{if !$PS_CATALOG_MODE}
			<div class="cart_block block exclusive" id="z_mini_cart_content">
                <div class="st-menu-title">{l s='Cart' mod='blockcart'}</div>
		...
		<div class="clearfix">
			...
			<div class="layer_cart_cart col-xs-12 col-md-6">
				...
				<div class="layer_cart_row">
					...
					<span class="price ajax_cart_shipping_cost{if $shipping_cost_float == 0 && (!isset($cart->id_address_delivery) || !$cart->id_address_delivery)} unvisible{/if}">
						{if $shipping_cost_float == 0}
