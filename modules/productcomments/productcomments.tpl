...
*}
<h3 class="idTabHrefShort page-product-heading">{l s='Reviews' mod='productcomments'}</h3> 
			...
			{foreach from=$comments item=comment}
				...
				<div class="comment row" itemprop="review" itemscope itemtype="http://schema.org/Review">
					...
					<div class="comment_details">
						...
						<ul class="comment-useful">
							{if $comment.total_advice > 0}
								<li class="total-advice">
							...
							{if $is_logged}
								...
								<li>
                                    ...
                                    <div class="usefulness_btn_wrapper">
