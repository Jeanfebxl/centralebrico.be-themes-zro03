...
<ul class="footer_links clearfix">
    ...
    <li class="logout"><a class="btn btn-default button button-small" href="{$link->getPageLink('index', true, NULL, 'mylogout=1')|escape:'html':'UTF-8'}" title="{l s='Sign out'}"><span><i class="icon-sign-out"></i> {l s='Sign out'}</span></a></li>
</ul>
