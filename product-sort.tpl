...
<ul class="display hidden-xs">
    ...
    <li id="grid"><a rel="nofollow" href="#" title="{l s='Grid'}" data-toggle="tooltip" data-placement="top"><i class="icon-th"></i></a></li>
    <li id="list"><a rel="nofollow" href="#" title="{l s='List'}" data-toggle="tooltip" data-placement="top"><i class="icon-th-list"></i></a></li>
    <li id="table"><a rel="nofollow" href="#" title="{l s='Table'}" data-toggle="tooltip" data-placement="top"><i class="icon-table"></i></a></li>
</ul>
