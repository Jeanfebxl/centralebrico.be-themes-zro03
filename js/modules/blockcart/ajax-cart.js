...
var stEffectRight = function() {
    $('#cart_sidebar_content').html($('#z_mini_cart_content').html());
    $('html').addClass('st-effect-right fancybox-margin st-menu-open');
...
$(document).ready(function(){
	...
	{
		$('#header .shopping_cart a:first').on('click', function(e){
            e.stopPropagation();
            e.preventDefault();
            stEffectRight();
		});		
...
var ajaxCart = {
	...
	add : function(idProduct, idCombination, addedFromProductPage, callerElement, quantity, whishlist){
		...
		if (addedFromProductPage)
		{
			...
			$(callerElement).prop('disabled', 'disabled').addClass('disabled');
		...
		$.ajax({
			...
			success: function(jsonData,textStatus,jqXHR)
			{
				...
				{
					if (contentOnly)
						window.parent.ajaxCart.updateCartInformation(jsonData, addedFromProductPage, callerElement);
					else
					...
					{
						if (contentOnly)
                            window.parent.ajaxCart.zCartSidebar();
						else
