						...
						<div class="row">
			            	<div class="left-side col-xs-12 col-sm-3">
								<div class="logo">
									...
									<img class="img-responsive" src="{$img_manu_dir}{$manufacturer.image|escape:'html':'UTF-8'}-manufacturer_default.jpg" alt="" />
									</a>
								</div> <!-- .logo -->
							</div> <!-- .left-side -->
							...
							<div class="middle-side col-xs-12 col-sm-5">
								<h3>
									<a class="" href="{$link->getmanufacturerLink($manufacturer.id_manufacturer, $manufacturer.link_rewrite)|escape:'html':'UTF-8'}">
